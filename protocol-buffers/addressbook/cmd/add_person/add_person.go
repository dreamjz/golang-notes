...
func promptForAddress(r io.Reader) (*pb.Person, error) {
	...
	// An int32 in the .proto file is represented as an int32 field
	...
	// A string field in the .proto file results in a string filed in Go.
	...
	for {
		...
		default:
			fmt.Printf("Unkown phone type %q. Using default.\n", ptype)
		}
